...
import {database, get, ref, onValue, push, set } from "../services/firebase"
  ...
  async function handleSendQuestion(event: FormEvent){
    ...
    if(!user) {
      ...
      const question = {
       ...
       const questionFirebase = ref(database, `rooms/${roomId}/questions`);
       const firebaseRoom = push(questionFirebase);
